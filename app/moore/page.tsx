      ...
      <section className="border-b border-black/10 py-20">
        <div className="mx-auto max-w-6xl px-4">
          <div className="max-w-3xl">
            <div className="text-sm font-medium text-black/50">Property Management — Moore, OK</div>
            <h1 className="mt-3 text-4xl font-semibold tracking-tight md:text-5xl">
              Moore property management. Professionally done.
            </h1>
            <p className="mt-5 max-w-2xl text-sm leading-7 text-black/70">
              Moore has a deep pool of quality renters — families, professionals, and workers tied to the south OKC corridor. <GridWord /> manages Moore rentals with professional photography, Matterport 3D tours, drone coverage, targeted social media, and syndication across 100+ platforms. Vacancies fill fast when properties are presented well.
            </p>
